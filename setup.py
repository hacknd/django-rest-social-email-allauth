...
setup(
	...
	# Description Area
	description="This is an authentication module template with social (Oauth2) Authentication, knox-rest and email account verification with password reset framework.With bot regulations(Under construction).",
